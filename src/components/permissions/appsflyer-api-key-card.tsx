...
(async () => {
  ...
  const buildPayload = (campaign, startDate, endDate) => ({
    ...
    'summations': ['totals'],
    // 매출은 대시보드와 같은 'calculated'(인앱 + 광고 매출 합산)로 요청.
    // 'core'로 보내면 일부 광고주 앱(Sofish·Sohi 등)은 D0~D30 이 최근 며칠 치로만 계산됨 (LTV 는 같아서 티가 안 남)
    'metrics': [
      ...
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': 'ltv', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriodLtv' },
      ...
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': '0', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriod0' },
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': '1', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriod1' },
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': '7', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriod7' },
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': '14', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriod14' },
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': '30', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriod30' },
      { 'metric-id': 'revenue', 'attribution-source': 'appsflyer', 'aggregation-type': 'cumulative', 'granularity': 'days', 'category': 'calculated', 'period': 'activity', 'filters': {}, 'platform-id': 'aggregationTypeCumulativeAttributionSourceAppsflyerFiltersGranularityDaysMetricIdRevenuePeriodActivity' },
